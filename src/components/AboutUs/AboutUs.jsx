  ...
  return (
    <div className="flex flex-col items-center gap-y-5 p-5 md:flex-row md:gap-x-5 md:justify-center md:items-start">
      <div className="flex flex-col items-center justify-center gap-y-2 md:w-3/4">
        <h3 className="text-[#333]-700 text-lg overflow-ellipsis whitespace-nowrap overflow-hidden">
          About this project
        </h3>

        <p className="text-center md:max-w-3xl md:leading-[2]">
          This is a clone of Swiggy application. Swiggy is a new-age
          consumer-first organization offering an easy-to-use convenience
          platform, accessible through a unified app.
        </p>

        {/* show these paragraphs only if expanded */}
        <p
          className={`text-center md:max-w-3xl md:leading-[2] ${
            isExpanded ? "block" : "hidden"
          } md:block`}
        >
          Class aptent taciti sociosqu ad litora torquent per conubia nostra,
          per inceptos himenaeos. Vestibulum sit amet erat ut lorem commodo
          porta.
        </p>
        ...
        >
          Cras scelerisque, ante ac gravida varius, eros lacus porta erat, et
          euismod orci nisi sed velit. Cras tristique augue dolor, ut blandit
          dui mollis at.
        </p>
